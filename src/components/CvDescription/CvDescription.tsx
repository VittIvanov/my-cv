        ...
        <section className="cv-info">
          ...
          <div className={`cv-info_more-information ${moreInfoClassName}`}>
            ...
            <div className="more-information_intro ">
              <p >
                Здравствуйте, меня зовут Виталий. Я фронтенд-разработчик с небольшим, но значимым опытом работы. За более чем десять лет я успел поработать в различных сферах, таких как торговля, маркетинг, IT-сфера и достиг определенных успехов в этих областях. Однако, я нашел свое истинное призвание в web-разработке.
