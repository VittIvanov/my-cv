      ...
      <article className="cv-description cv-container">
        <section className="cv-info">
          ...
          <div className={`cv-info_min-information ${minInfoClassName}`}>
            <p>Привет! Я занимаюсь frontend-разработкой, обладаю знаниями в HTML, CSS, JavaScript и фреймворках, таких как React. Я постоянно слежу за последними технологическими тенденциями и непрерывно совершенствую свои навыки. Уверен, что мои умения помогут вам достичь ваших целей в будущем.
            </p>
          ...
          <div className={`cv-info_more-information ${moreInfoClassName}`}>
            ...
            <div className="more-information_intro ">
              <p >
                Здравствуйте, меня зовут Виталий. Я frontend-разработчик с небольшим, но значимым опытом работы. За более чем десять лет я успел поработать в различных сферах, таких как торговля, маркетинг, IT-сфера и достиг определенных успехов в этих областях. Однако, я нашел свое истинное призвание в web-разработке.

                Меня всегда привлекала IT-сфера своими перспективами и постоянным развитием, а frontend-разработка в особенности - своей эстетикой и функциональностью. Я получаю огромное удовольствие от создания приложений, которые удовлетворяют потребности пользователей и обеспечивают им лучший опыт взаимодействия.
              </p>
            </div>
        ...
        <section className="cv-details details-container">
          ...
          <div className="cv-details_career details-container_item">
            <h2>Карьера</h2>
            <ul>
              <div className={` ${careerInfoClassName}`}>

                <li>
                  <p>Торговая кампания "ТЕХНИКОFF"</p>
                  <div>Продавец-консультант</div>
                  <div>2007-2009г.</div>
                </li>
                <li>
                  <p>ОСОО "Лунтай-трейд"</p>
                  <div>Экспедитор</div>
                  <div>2009-2011г.</div>
                  <div>Завсклад, продавец</div>
                  <div>2011-2016г.</div>
                </li>
                <li>
                  <p>Индивидуальный предприниматель</p>
                  <div>Торговый предприниматель</div>
                  <div>с 2016г.</div>
                </li>
              ...
              <li>
                <p>Работаю во фрилансе:</p>
                <div>frontend-разработка, верстка лендингов, SPA-приложений, оптимизация и расширение готовых проектов</div>
                <div>с 2021г.</div>
              </li>
